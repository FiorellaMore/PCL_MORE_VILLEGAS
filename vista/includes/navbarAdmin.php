<nav class="app-navbar navbar border-bottom bg-white">
    ...
    <div class="nav nav-pills flex-file mb-auto">
        <li class='nav-item'>
            <a class="nav-link link-dark" href="../../vista/usuarios">Usuarios</a>
        </li>
        <li class='nav-item' >
            <a class="nav-link link-dark" href="../../vista/roles">Rol</a>
        </li>
        <li class='nav-item' >
            <a class="nav-link link-dark" href="../../vista/empleados">Empleados</a>
        </li>
    </div>
</div>
        <div class="btn-group pe-5">
            ...
            <div class="rounded-circle overflow-hidden" style="width: 42px; height: 42px; cursor: pointer;"
                ...
                <img src=../../img/avatar1.png class="w-100 h-100"/>
            </div>
