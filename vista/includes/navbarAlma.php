<nav class="app-navbar navbar border-bottom bg-white">
    ...
    <div class="nav nav-pills flex-file mb-auto">
        <li class='nav-item'>
            <a class="nav-link link-dark" href="../../vista/categorias">Categorias</a>
        </li>
        <li class='nav-item' >
            <a class="nav-link link-dark" href="../../vista/productos">Productos</a>
        </li>
    </div>
</div>
        <div class="pe-5 btn-group">
            ...
            <div class="rounded-circle overflow-hidden" style="width: 42px; height: 42px; cursor: pointer;"
                ...
                <img src=../../img/avatar3.png class="w-110 h-100"/>
            </div>
