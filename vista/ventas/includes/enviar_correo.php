<div class="modal fade" id="newemail" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="../../controlador/venta/enviar-correo.php">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Contacto con Cliente</h4>
                </div>
                <div class="modal-body">
                    <div class="row d-grid gap-3">
                        <div class="col-md-12">
                            <label for="inputEmail" class="form-label">Para</label>
                            <input type="email" class="form-control" id="inputEmail" placeholder="Ingresar correo del cliente" name="email_receptor"/>
                        </div>
                        <div class="col-md-12">
